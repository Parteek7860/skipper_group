...
namespace skipper_group_new.Service
{
    public class clsSkipperHome : ISkipperHome
    {
        ...
        public Task<DataTable> GetMapGalleryProjectList() => this._repository.GetMapGalleryProjectList();
        ...
        public Task<DataTable> GetBannerPopupList() => this._repository.GetBannerPopupList();
        ...
        public Task<DataTable> GetLicenseExpire() => this._repository.GetLicenseExpire();
    }
